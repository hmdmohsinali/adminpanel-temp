...
export function Addadmin() {
  ...
  const handelFormSubmitSubadmin = async (e) => {
    try {
      ...
      // console.log(addadmin.profileImageFile)
      // if (!(addadmin.profileImageFile instanceof File)) {
      //   toast.info("Please select profile Image")
      //   return;
      // }

      setloading(true)
      // const fileRefSnapshot = await uploadBytes(ref(storageRef, addadmin.profileImageFile.name), addadmin.profileImageFile);
      // const profileImage = await getDownloadURL(fileRefSnapshot.ref);

      // if (!profileImage) {
      //   toast.info("failed to upload profile Image")
      //   setloading(false)
      ...
      if (success) {
        ...
        navigate(`/csmconnect/AdminsList`)
      } else {
