          ...
          <ul className="space-y-2 h-96 ">
            <div className={`${style.heightScroll} pt-3 `}>
              <li className="my-2">
                <Link
                  ...
                  className={classNames(
                    location.pathname === "/csmconnect/starter"
              ...
              <li className="my-2">
                <Link
                  className={classNames(
                    location.pathname === "/csmconnect/meetupmanage"
                      ? "text-black bg-gray-200"
                      : "text-white",
                    " flex items-center p-2 text-base font-medium  rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-200 hover:text-black group "
                  )}
                  to="/csmconnect/meetupmanage"
                >
                  <img
                    src={"/v4.png"}
                    alt="Authentication Icon"
                    className="flex-shrink-0 w-6 h-6"
                  />
                  <span className="ml-3">Meetup Managment</span>
                </Link>
              </li>
              <li className="my-2">
                <Link
                  className={classNames(
                    location.pathname === "/csmconnect/usermanagment"
                      ? "text-black bg-gray-200"
                      : "text-white",
                    " flex items-center p-2 text-base font-medium  rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-200 hover:text-black group "
                  )}
                  to="/csmconnect/usermanagment"
                >
                  <img
                    src={"/v1.png"}
                    alt="Authentication Icon"
                    className="flex-shrink-0 w-6 h-6"
                  />
                  <span className="ml-3">User Managment</span>
                </Link>
              </li>
              <li className="my-2">
                <Link
                  className={classNames(
                    location.pathname === "/csmconnect/adminuserchat"
                      ? "text-black bg-gray-200"
                      : "text-white",
                    " flex items-center p-2 text-base font-medium  rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-200 hover:text-black group "
                  )}
                  to="/csmconnect/adminuserchat"
                >
                  <img
                    src={"/v2.png"}
                    alt="Authentication Icon"
                    className="flex-shrink-0 w-6 h-6"
                  />
                  <span className="ml-3">Admin User Chat</span>
                </Link>
              </li>
              <li className="my-2">
                <Link
                  className={classNames(
                    location.pathname === "/csmconnect/userchat"
                      ? "text-black bg-gray-200"
                      : "text-white",
                    " flex items-center p-2 text-base font-medium  rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-200 hover:text-black group "
                  )}
                  to="/csmconnect/userchat"
                >
                  <img
                    src={"/v3.png"}
                    alt="Authentication Icon"
